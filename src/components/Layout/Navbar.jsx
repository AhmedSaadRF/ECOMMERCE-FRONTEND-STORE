...
import { toggleSidebar, toggleSearchBar, toggleCart, toggleAuthPopup } from "../../store/slices/popupSlice";
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button onClick={() => dispatch(toggleCart())} className="relative p-2 rounded-lg hover:bg-secondary transition-colors">
              ...
              {cartItemsCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-primary text-primary-foreground text-xs rounded-full w-5 h-5 items-center justify-center">
                  {cartItemsCount}
                </span>
              )}
            </button>
