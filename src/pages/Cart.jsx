    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center glass-panel max-w-md">
          ...
          <p className="text-muted-foreground mb-8">Your cart is empty. Please add some products to your cart.</p>
          <Link
            to="/products"
            ...
            <div className="lg:col-span-1">
              <div className="glass-panel sticky top-24">
                ...
                {authUser && (
                  <Link 
                    to={"/payment"} 
                    className="w-full block text-center py-4 gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold mb-4">Proceed to Checkout</Link>
                )}

                <Link 
                  to={"/products"} 
                  className="w-full block text-center py-4 bg-secondary text-foreground rounded-lg animate-smooth font-semibold mb-4 border-border hover:bg-accent">Continue Shopping</Link>
              </div>
            </div>
          </div>
        </div>
